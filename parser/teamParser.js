...
exports.parse = function(url, teamName, callback){
    request("http://www.extraskater.com/players/standard?team="+url+"&season=2013&sit=all", function(err, resp, body) {
    if (err)
      throw (err);
